...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .titulo-segundo.color-secundario(data-aos="fade-right")
      h2 2.1  Propuesta 1 carrusel

    .row.justify-content-center.align-items-center.BG03.mb-5
      .col-lg-12
        #carouselExampleIndicators.carousel.slide.color-secundario(data-bs-ride='carousel')
          .carousel-indicators
          ...
          .carousel-inner
            .carousel-item.active
              .row.justify-content-center.align-items-center.mb-5
                .col-lg-4
                  h4 Texto que acompaña la imagen
                .col-lg-8
                  figure
            ...
            .carousel-item
              .row.justify-content-center.align-items-center.mb-5
                .col-lg-4
                  h4 Titulo que acompaña la imagen
                .col-lg-8
                  figure
    ...
    .titulo-segundo.color-secundario(data-aos="fade-right")
      h2 2.2 Parallax Flipping Cards
      ...
      .col-lg-3
        .tarjeta.tarjeta-flip.color-primario(@mouseover="indicadorTarjetaFlip = false")
          ...
          .tarjeta-flip__contenedor
            .tarjeta-flip__img(:style="{'background-image': `url(${require('@/assets/componentes/ej-05.svg')})`}")
